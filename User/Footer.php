...
<head>
    ...
    <style>
        ...
        @media (max-width: 992px) {
            ...
            .footer-copyright-text, .footer-social-container {
                text-align: center;
            }
    ...
    <div class="footer-copyright">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <p class="footer-copyright-text">&copy; <script>document.write(new Date().getFullYear());</script> DecoNest Home Decor. Crafted with <i class="fas fa-heart" style="color: #c0a87d;"></i> for beautiful homes.</p>
                </div>
                <div class="col-lg-4">
                    <div class="footer-social-container"> 
                        <div class="footer-social-icon">
                            <a href="#" class="footer-social-link"><i class="fab fa-pinterest"></i></a>
                            <a href="#" class="footer-social-link"><i class="fab fa-instagram"></i></a>
                            <a href="#" class="footer-social-link"><i class="fab fa-facebook-f"></i></a>
                            <a href="#" class="footer-social-link"><i class="fab fa-houzz"></i></a>
                        </div>
                    </div>
                </div>
            </div>
