...
<title>Product List - DecoNest</title>
...
body {
    background: linear-gradient(135deg, #667eea 0%, #52495cff 100%);
    min-height: 100vh;
    padding: 20px 0;
}

.products-hero {
    background: linear-gradient(rgba(102, 126, 234, 0.9), rgba(98, 77, 120, 0.9)),
...
<body>
    ...
    <div class="products-hero">
        <div class="container">
            <h1><i class="fas fa-store"></i> Product Collection</h1>
