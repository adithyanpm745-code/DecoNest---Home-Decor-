...
$selqry = "SELECT 
           ...
           WHERE p.seller_id = '$sellerId' AND b.booking_status >= 5 AND c.cart_status = 1
...
<div class="container">
    ...
    <a href="ViewBooking.php" class="btn"> View Booking Orders </a><br><br><br>
                ...
                <span>
                    <?php 
                        $statusText = [
                            ...
                            4 => "Product Shipped",
                            5 => "Order Completed",
                            6 => '<h6 style="color: red;">Order Cancelled</h6>'
