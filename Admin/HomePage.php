...
<form id="form1" name="form1" method="post" action="">
  <table width="200" border="1" cellpadding="10">
    ...
    <tr>
     ...
     <tr>
      <td>Colour</td>
      <td><a href="Colour.php">Colour</a></td>
    </tr>
    <tr>
      <td>Material</td>
      <td><a href="Material.php">Material</a></td>
    </tr>
    <tr>
      <td>Seller List</td>
      <td><a href="SellerList.php">Seller List</a></td>
    </tr>
    <tr>
      <td>User List</td>
     ...
     <tr>
      ...
      <td><a href="ViewComplaint.php">View Complaint</a></td>
    </tr>
     <tr>
      <td>View FeedBack></td>
        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              ...
              <!-- <li class="nav-item">fa-solid fa-right-from-bracket
                <a href="widgets.html">
                ...
                <li class="nav-item topbar-icon dropdown hidden-caret">
                  ...
                  >
                    <i class="fa fa-envelope">
                      <!-- <img
                                src="../Assets/Templates/Admin/assets/img/chart.png" 
                                alt="Img Profile" height="50" width="50"
                              /> -->
                    </i>
                  </a>
                  <ul
          ...
          <div class="page-inner">
            ...
            >
              ...
              <div class="ms-md-auto py-2 py-md-0">
                <a href="SellerList.php" class="btn btn-label-info btn-round me-2">View Seller</a>
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col col-stats ms-3 ms-sm-0">
                        <div class="numbers">
                          ...
                          <h4 class="card-title"><?php echo number_format($totalSales); ?></h4>
                        </div>
                      </div>
                    </div>
                  </div>
