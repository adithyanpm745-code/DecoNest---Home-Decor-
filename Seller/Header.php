    ...
    <header class="main_menu home_menu">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light"><br><br><br><br><br><br><br><br><br><br>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_2">
                                        ...
                                        <a class="dropdown-item" href="ViewCustomization.php">View Customization</a>
                                        <?php endif; ?>
                                        <a class="dropdown-item" href="ViewComplaint.php">View Complaints</a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="Report1.php">View Report</a>
                                </li>
                                <li class="nav-item">
