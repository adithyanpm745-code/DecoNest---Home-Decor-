...
<div class="container container-custom">
    ...
    <div class="row">
        <?php
        $i = 0;
        $SelQry = "select * from tbl_customization c 
        inner join tbl_seller s on c.seller_id=s.seller_id
        inner join tbl_user u on c.user_id=u.user_id
         where s.seller_id='".$_GET['sellercustom']."'";
       // where c.user_id='".$_SESSION['uid']."' group by c.customization_id ORDER BY c.customization_id DESC";
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="seller-info">
                                <h6 class="mb-3"><i class="fas fa-store mr-2"></i>User Details</h6>
                                <p class="mb-1"><strong>Name:</strong> <?php echo $data['user_name']; ?></p>
                                <p class="mb-1"><strong>Email:</strong> <?php echo $data['user_email']; ?></p>
                                <p class="mb-1"><strong>Address:</strong> <?php echo $data['user_address']; ?></p>
                                <p class="mb-0"><strong>Contact:</strong> <?php echo $data['user_contact']; ?></p>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="content-box mb-3">
                                ...
                                <p class="mb-0"><?php echo $data['customization_content']; ?></p>
                            </div>
        ...
        <div class="col-12 text-center py-5">
            ...
            <h4 class="text-muted">No Customization Found </h4>
            <p>You haven't made any customization requests at seller.</p>
        </div>
        <?php
        }
        ?>
